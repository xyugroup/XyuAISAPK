    ...
    public class ClientThread implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Object serverAddr = getByName(IP);
                Boolean state_connnect = true;

                Scanner in;

                while (state_connnect) {

                    Socket s = new Socket((String) serverAddr, 4444);

                    in = new Scanner(s.getInputStream());
                    String IN_message = in.nextLine();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_start:
                ...
                try {
                    Socket echoSocket = new Socket("192.168.1.104", 10000);
                } catch (IOException e) {
                    e.printStackTrace();
                }
                ...
                try {
                    ...
                    Object serverAddr = InetAddress.getByName(IP);
                    Boolean state_connnect = true;
